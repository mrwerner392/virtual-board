class User {
  ...
  renderWhiteboard() {
    let whiteboard = new WhiteBoard(this.whiteboard.id, this.whiteboard.title, this.whiteboard.to_dos, this.whiteboard.quotes, this.whiteboard.thoughts, /*this.whiteboard.doodleCoords,*/ this.id)
